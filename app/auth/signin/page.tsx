...
import { Mail, Lock, ArrowRight, AlertCircle, Eye, EyeOff, Sparkles, Shield } from 'lucide-react';
                    ...
                    <div className="relative bg-white dark:bg-dark-800 p-8 md:p-10 rounded-3xl shadow-2xl border border-gray-200 dark:border-dark-700 backdrop-blur-xl">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.98 }}
                                className="w-full relative group bg-gradient-to-r from-primary-600 via-primary-500 to-accent-600 text-white py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden"
                            >
                        ...
                        <div className="mt-8 space-y-4">
                            <p className="text-center text-gray-600 dark:text-gray-400">
                                ...
                                <Link href="/auth/register" className="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-bold hover:underline">
                                    Create Account
                                </Link>
                            </p>
